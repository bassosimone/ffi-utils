...
public class MkNettestJNI {
  ...
  public final static native String Runner_prepare_captive_portal(long jarg1, Runner jarg1_, long jarg2, CaptivePortal jarg2_);
  public final static native String Runner_prepare_dash(long jarg1, Runner jarg1_, long jarg2, Dash jarg2_);
  public final static native String Runner_prepare_dns_injection(long jarg1, Runner jarg1_, long jarg2, DnsInjection jarg2_);
  public final static native String Runner_prepare_facebook_messenger(long jarg1, Runner jarg1_, long jarg2, FacebookMessenger jarg2_);
  public final static native String Runner_prepare_http_header_field_manipulation(long jarg1, Runner jarg1_, long jarg2, HttpHeaderFieldManipulation jarg2_);
  public final static native String Runner_prepare_http_invalid_request_line(long jarg1, Runner jarg1_, long jarg2, HttpInvalidRequestLine jarg2_);
  public final static native String Runner_prepare_meek_fronted_requests(long jarg1, Runner jarg1_, long jarg2, MeekFrontedRequests jarg2_);
  public final static native String Runner_prepare_multi_ndt(long jarg1, Runner jarg1_, long jarg2, MultiNdt jarg2_);
  public final static native String Runner_prepare_ndt(long jarg1, Runner jarg1_, long jarg2, Ndt jarg2_);
  public final static native String Runner_prepare_tcp_connect(long jarg1, Runner jarg1_, long jarg2, TcpConnect jarg2_);
  public final static native String Runner_prepare_telegram(long jarg1, Runner jarg1_, long jarg2, Telegram jarg2_);
  public final static native String Runner_prepare_web_connectivity(long jarg1, Runner jarg1_, long jarg2, WebConnectivity jarg2_);
  public final static native String Runner_prepare_whatsapp(long jarg1, Runner jarg1_, long jarg2, Whatsapp jarg2_);
  public final static native void Runner_run(long jarg1, Runner jarg1_, String jarg2);
